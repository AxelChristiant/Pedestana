    ...
    <section id="contact">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 mr-auto">
            <p class="lead">Yang beranggotakan lima orang yaitu: Dhiqi, Kemal Tirta, Aditya Raka, Axel Cristiant dan Azmiardhy Zulkifli
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <p class="lead mb-0">Jadilah bagian dari keluarga kami Teknik Informatika UII
